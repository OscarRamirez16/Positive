...
{
    public partial class frmReporteDocumentosPagos : PaginaBase
    {
        ...
        protected void btnBuscar_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                string strRutaReporte = "Reportes/ReporteDocumentosPagos.rdlc";
                ReportDataSource rdsDatos = new ReportDataSource();
                rdsDatos.Value = oDocB.ObtenerDocumentosPagos(DateTime.Parse(txtFechaInicial.Text), DateTime.Parse(txtFechaFinal.Text), long.Parse(ddlUsuario.SelectedValue), txtDocumento.Text.Trim(), oUsuarioI.idEmpresa);
