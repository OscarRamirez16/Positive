<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmReporteAuditoriaStock.aspx.cs" Inherits="Inventario.frmReporteAuditoriaStock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-1">Bodega:</div>
        <div class="col-md-3">
            <div class="input-group">
                <asp:DropDownList ID="ddlBodegas" runat="server" CssClass="form-control" DataTextField="Descripcion" DataValueField="IdBodega"></asp:DropDownList>
                <span class="input-group-addon">
