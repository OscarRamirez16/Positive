<%@ Page Title="Ingresos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmIngresos.aspx.cs" Inherits="Inventario.frmIngresos" %>
        ...
        <div class="col-lg-6 col-lg-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <textarea id="txtObser" runat="server" class="form-control" rows="5" style="width: 98%"></textarea>
                        </div>
                    </div>
                    <div class="row"><div class="col-lg-12"><br /></div></div>
                    <div class="row">
