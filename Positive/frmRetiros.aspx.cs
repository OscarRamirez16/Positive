...
{
    public partial class frmRetiros : PaginaBase
    {
            ...
            try
            {
                ...
                if (oUsuarioI != null)
                {
                    ...
                    if (ValidarCajaAbierta())
                    {
                        ...
                        oRolPagI = oSegB.TraerPermisosPaginasPorUsuario(oUsuarioI.idUsuario, oUsuarioI.idEmpresa, short.Parse(SeguridadBusiness.paginasEnum.Retiros.GetHashCode().ToString()));
                        if (oRolPagI.Leer)
                        {
                            ConfiguracionIdioma();
        ...
        private void ConfiguracionIdioma()
        {
            ...
            lblTitulo.Text = string.Format("{0} {1}", oCIdioma.TraducirPalabra(Idioma, Traductor.IdiomaPalabraEnum.Retirar), oCIdioma.TraducirPalabra(Idioma, Traductor.IdiomaPalabraEnum.Efectivo));
