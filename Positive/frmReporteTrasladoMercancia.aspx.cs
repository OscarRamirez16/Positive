...
namespace Positive
{
    public partial class frmReporteTrasladoMercancia : PaginaBase
    {
        ...
        protected void btnBuscar_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                tblTrasladoMercanciaBusiness oTrasB = new tblTrasladoMercanciaBusiness(CadenaConexion);
                string strRutaReporte = "Reportes/ReporteTrasladosMercancia.rdlc";
                ReportDataSource rdsDatos = new ReportDataSource();
                rdsDatos.Value = oTrasB.ObtenerTrasladoMercancia(DateTime.Parse(txtFechaInicial.Text), DateTime.Parse(txtFechaFinal.Text), long.Parse(ddlUsuario.SelectedValue), oUsuarioI.idEmpresa, chkAgrupado.Checked);
