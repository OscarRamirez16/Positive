<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmReporteComisionesVentasPorArticulo.aspx.cs" Inherits="Positive.frmReporteComisionesVentasPorArticulo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <div class="row">
        <div class="col-md-2"></div>
        <div class="col-md-1">Vendedor:</div>
        <div class="col-md-3">
            <div class="input-group">
                ...
                <span class="input-group-addon">
                <img src="Images/Input/SocioNegocio.png" title="Vendedor" /></span>
            </div>
        </div>
        <div class="col-md-2"></div>
    </div>
