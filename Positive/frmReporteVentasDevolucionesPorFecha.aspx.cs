...
{
    public partial class frmReporteVentasDevolucionesPorFecha : PaginaBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (oUsuarioI != null)
                {
                    ...
                    oRolPagI = oSegB.TraerPermisosPaginasPorUsuario(oUsuarioI.idUsuario, oUsuarioI.idEmpresa, short.Parse(SeguridadBusiness.paginasEnum.ReporteVentasDevolucionesPorFecha.GetHashCode().ToString()));
                    if (oRolPagI.Leer)
                    {
        ...
        protected void btnBuscar_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                strRutaReporte = "Reportes/ReporteVentasDevolucionesDetalladasPorRangoFechas.rdlc";
                ReportDataSource rdsDatos = new ReportDataSource();
                rdsDatos.Value = oDocB.ObtenerVentasDevolucionesPorFecha(DateTime.Parse(txtFechaInicial.Text), DateTime.Parse(txtFechaFinal.Text), oUsuarioI.idEmpresa);
