...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <div class="row">
        <div class="col-md-12" style="text-align:center">
            <asp:DataGrid ID="dgAnticipos" CssClass="table-responsive" OnItemCommand="dgAnticipos_ItemCommand" runat="server" Width="100%" HeaderStyle-BackColor="#E5E5E5" AlternatingItemStyle-BackColor="#F8F8F8" AutoGenerateColumns="False" HeaderStyle-HorizontalAlign="Center">
                ...
                <Columns>
                    ...
                    <asp:ButtonColumn Visible="false" CommandName="Anular" Text="Anular"></asp:ButtonColumn>
                    <asp:ButtonColumn CommandName="Imprimir" Text="Imprimir"></asp:ButtonColumn>
                    <asp:ButtonColumn Visible="false" CommandName="ImprimirFormal" Text="<img src='Images/btnimprimir.png' Width='18' Height='18' title='Impresión Formal' />"></asp:ButtonColumn>
                </Columns>
            </asp:DataGrid>
        </div>
    </div>
