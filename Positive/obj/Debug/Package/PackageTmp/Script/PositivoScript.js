function MostrarAlertaInfo(Tittle) {
    Swal.fire({
        title: Tittle,
        icon: 'warning',
        showClass: {
...
function MostrarAlertaSuccess(Tittle, Mensaje) {
    Swal.fire(
        Tittle,
        Mensaje,
        'success'
...
function MostrarAlertaError(Tittle, Mensaje) {
    Swal.fire({
        icon: 'error',
        title: Tittle,
        text: Mensaje
...
function FormatearGrid(ClientID) {
    $('#' + ClientID).addClass("table");
    $('#' + ClientID).addClass("table-striped");
    $('#' + ClientID).addClass("table-bordered");
    $('#' + ClientID).addClass("table-hover");
    var $firstRow = $("#" + ClientID + " tr:first");
...
function AnularFacturaVenta(idDocumento) {
    let text = "Esta seguro que desea eliminar la Factura de Venta";
    if (confirm(text) == true) {
        var url = "frmAnularFactura.aspx?idDocumento=" + idDocumento;
