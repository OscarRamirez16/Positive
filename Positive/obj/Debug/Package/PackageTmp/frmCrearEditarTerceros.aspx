...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
        ...
        <div class="col-md-6">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" id="divZipCode">
                        <div class="col-lg-4">
                            <asp:Label ID="lblZipCode" Font-Bold="true" runat="server"></asp:Label>
                        </div>
                        <div class="col-lg-7">
                            <div class = "input-group">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-success" runat="server" id="divEmpresa">
                <div class="panel-heading">
                    <span>Datos de la Empresa</span>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-1"><asp:CheckBox ID="chkCrearEmpresa" Checked="false" runat="server" Text="Crear Empresa" /></div>
                        <div class="col-md-2">Servidor</div>
                        <div class="col-md-3"><asp:DropDownList ID="ddlServidor" CssClass="form-control" runat="server" AutoPostBack="false"></asp:DropDownList></div>
                        <div class="col-md-3">Prefijo</div>
                        <div class="col-md-3">
                            <div class = "input-group">
                                <asp:TextBox ID="txtPrefijo" runat="server" CssClass="form-control"></asp:TextBox>
                                <span class="input-group-addon"><img src="Images/Input/Identificacion.png" title="Prefijo" /></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">Texto Encabezado Factura</div>
                        <div class="col-md-3">
                            <asp:TextBox ID="txtEncabezado" TextMode="MultiLine" Rows="4" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-3">Texto Pie Factura</div>
                        <div class="col-md-3">
                            <asp:TextBox ID="txtPie" TextMode="MultiLine" Rows="4" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class = "input-group">
                                ...
                                <span class = "input-group-addon"><img src="Images/Input/SocioNegocio.png" title="Primer Nombre" /></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class = "input-group">
                                ...
                                <span class = "input-group-addon"><img src="Images/Input/SocioNegocio.png" title="Segundo Nombre" /></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class = "input-group">
                                ...
                                <span class = "input-group-addon"><img src="Images/Input/SocioNegocio.png" title="Primer Apellido" /></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class = "input-group">
                                ...
                                <span class = "input-group-addon"><img src="Images/Input/SocioNegocio.png" title="Segundo Apellido" /></span>
                            </div>
                        </div>
                    </div>
                </div>
