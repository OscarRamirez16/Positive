<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmReporteCuentaCobro.aspx.cs" Inherits="Positive.frmReporteCuentaCobro" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-1"><asp:Label ID="lblTercero" runat="server"></asp:Label>:</div>
        <div class="col-md-3">
            <div class="input-group">
                <asp:TextBox ID="txtTercero" runat="server" CssClass="form-control"></asp:TextBox>
                <input type="hidden" value="0" id="hddIdCliente" runat="server" />
                <span class="input-group-addon">
