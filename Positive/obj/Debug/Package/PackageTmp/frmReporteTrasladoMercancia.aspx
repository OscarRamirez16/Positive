<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmReporteTrasladoMercancia.aspx.cs" Inherits="Positive.frmReporteTrasladoMercancia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12" style="text-align:center">
            <b>Reporte Traslados de Mercancia</b>
        </div>
        <br />
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-4"><asp:CheckBox ID="chkAgrupado" runat="server" Text="Agrupado" /></div>
        <div class="col-md-2"></div>
    </div>
    <div class="row">
        <div class="col-md-12" style="text-align:center">
