...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            Clave Certificado:
            <div class="input-group">
                <asp:TextBox ID="txtClaveCertificado" runat="server" CssClass="form-control"></asp:TextBox>
                <span class="input-group-addon"><img src="Images/Input/Identificacion.png" title="Clave Tecnica" /></span>
            </div>
        </div>
        <%--<div class="col-md-3">
