            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <asp:Label ID="lblProximoValor" Text="Proximo Valor" runat="server"></asp:Label>:
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <asp:Label ID="lblValorInicial" Text="Valor Inicial" runat="server"></asp:Label>:
                        </div>
                        <div class="col-lg-6">
                            <asp:Label ID="lblValorFinal" Text="Valor Final" runat="server"></asp:Label>:
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <asp:Label ID="lblResolucion" Text="Resolucion DIAN" runat="server"></asp:Label>:
                        </div>
                        <div class="col-lg-6"></div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <asp:Label ID="lblFechaVencimiento" Text="Fecha Vencimiento" runat="server"></asp:Label>:
                        </div>
                        <div class="col-lg-6"></div>
                    </div>
                    <div class="row">
