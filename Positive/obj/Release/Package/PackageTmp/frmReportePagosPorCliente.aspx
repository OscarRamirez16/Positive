<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmReportePagosPorCliente.aspx.cs" Inherits="Inventario.frmReportePagosPorCliente" %>
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    <table class="table" style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtClienteBus" CssClass="Box" runat="server"></asp:TextBox><input type="hidden" value="0" id="hddIdClienteBus" runat="server" />
                <asp:RequiredFieldValidator ID="rfvCliente" ControlToValidate="txtClienteBus" ErrorMessage="*" runat="server"></asp:RequiredFieldValidator>
            </td>
        ...
        <tr>
            <td colspan="4"><asp:DataGrid ID="dgPagos" runat="server" Width="100%" HeaderStyle-BackColor="#E5E5E5" AlternatingItemStyle-BackColor="#F8F8F8" AutoGenerateColumns="False" HeaderStyle-HorizontalAlign="Center" OnItemCommand="dgPagos_ItemCommand" >
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="Tercero" HeaderText="Cliente"></asp:BoundColumn>
