<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmVerPagoProveedor.aspx.cs" Inherits="Inventario.frmVerPagoProveedor" %>
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    <table class="table" style="width: 100%">
        <tr class="tr" style="text-align: center;">
            <td colspan="2"><b>Pagos Por Proveedor</b></td>
        </tr>
        <tr>
