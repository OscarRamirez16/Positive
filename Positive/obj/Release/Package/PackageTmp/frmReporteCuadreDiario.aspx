<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmReporteCuadreDiario.aspx.cs" Inherits="Inventario.frmReporteCuadreDiario" %>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="input-group">
                ...
                <span class="input-group-addon">
                <img src="Images/Date.png" title="Caja" /></span>
            </div>
        </div>
        <div class="col-md-2"></div>
    </div>
